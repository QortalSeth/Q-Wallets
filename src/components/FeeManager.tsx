...
export const FeeManager = ({coin, onChange}) => {
     const {selectedFeePublisher, setSelectedFeePublisher, currentFee, selectFeeType, setSelectFeeType, data, customFee, setCustomFee} = useRecommendedFees({selectedCoin: coin})
  ...
  return (
           <div style={{
              ...
              >
                ...
                <Typography id="ltc-fee-slider" sx={{
                  marginTop: '15px'
                }}>
